...
def init_estimator(
    ...
    estimator_dict = {
        ...
        'adaboost_binary_classification': AdaBoostClassifier(
            random_state=seed,
        ),
        ...
        'xgboost_binary_classification': GradientBoostingClassifier(
            random_state=seed,
        ),
        'forest_regression': RandomForestRegressor(
            random_state=seed,
        ),
        'extreme_forest_regression': ExtraTreesRegressor(
            random_state=seed,
        ),
        'adaboost_regression': AdaBoostRegressor(
            random_state=seed,
        ),
        'xgboost_regression': GradientBoostingRegressor(
            random_state=seed,
        ),
    }
